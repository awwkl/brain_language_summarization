...
if __name__ == '__main__':
    ...
    test_t_per_feat = loaded.item()['test_t']               # (1191, 27905)
    print(test_t_per_feat.shape)
    
    n_class = 20   # how many predictions to classify at the same time
    n_folds = 4
    
    neighborhoods = np.load('./data/voxel_neighborhoods/' + args.subject + '_ars_auto2.npy')    # (27905, 80)
    n_words, n_voxels = test_t_per_feat.shape               # n_words = 1191, n_voxels = 27905
